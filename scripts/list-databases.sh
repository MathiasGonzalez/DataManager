...
echo "  docker compose --profile tools run --rm db_utils psql -h postgres -U postgres -c \"CREATE DATABASE myproject_db;\""
echo ""
echo "Backup specific database:"
echo "  docker compose --profile tools run --rm db_utils backup.sh myproject_db"
echo ""
echo "Backup all databases:"
echo "  docker compose --profile tools run --rm db_utils backup-all.sh"
echo ""
echo "Connect to database:"
echo "  docker compose --profile tools run --rm db_utils psql -h postgres -U postgres -d myproject_db"
echo "============================================"
